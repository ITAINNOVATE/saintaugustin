            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              <button
                ...
                onClick={() => {
                  ...
                  setEmail("admin@saintaugustin.bj");
                  setPassword("demo1234");
                  router.push("/admin");
                }}
                className="p-2.5 bg-[#0A1628] text-white hover:bg-[#1E4070] rounded-xl text-xs font-bold text-left transition-all flex items-center justify-between shadow-sm hover:scale-[1.02] cursor-pointer"
              >
                <span>👑 Admin</span>
              </button>
              ...
              <button
                type="button"
                onClick={() => {
                  document.cookie = "demo_role=directeur; path=/";
                  setEmail("directeur@saintaugustin.bj");
                  setPassword("demo1234");
                  router.push("/directeur");
                }}
                className="p-2.5 bg-[#0F2A53] text-white hover:bg-[#2D578D] rounded-xl text-xs font-bold text-left transition-all flex items-center justify-between shadow-sm hover:scale-[1.02] cursor-pointer"
              >
                <span>📊 Directeur</span>
              </button>
              ...
              <button
                type="button"
                onClick={() => {
                  document.cookie = "demo_role=secretaire; path=/";
                  setEmail("secretaire@saintaugustin.bj");
                  setPassword("demo1234");
                  router.push("/secretaire");
                }}
                className="p-2.5 bg-[#00C9A7] text-white hover:bg-[#00B397] rounded-xl text-xs font-bold text-left transition-all flex items-center justify-between shadow-accent hover:scale-[1.02] cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={() => {
                  document.cookie = "demo_role=moniteur; path=/";
                  setEmail("moniteur@saintaugustin.bj");
                  setPassword("demo1234");
                  router.push("/moniteur");
                }}
                className="p-2.5 bg-[#8E44AD] text-white hover:bg-[#9B59B6] rounded-xl text-xs font-bold text-left transition-all flex items-center justify-between shadow-sm hover:scale-[1.02] cursor-pointer"
              >
                <span>🚗 Moniteur</span>
              </button>
              ...
              <button
                ...
                onClick={() => {
                  document.cookie = "demo_role=apprenant; path=/";
                  setEmail("apprenant@saintaugustin.bj");
                  setPassword("demo1234");
                  router.push("/apprenant/cours");
                }}
                className="p-2.5 bg-[#F5A623] text-[#0A1628] hover:bg-[#F9CC74] rounded-xl text-xs font-extrabold text-left transition-all flex items-center justify-between shadow-gold hover:scale-[1.02] cursor-pointer col-span-2 sm:col-span-1"
              >
                <span>🎓 Apprenant</span>
              </button>
            </div>
